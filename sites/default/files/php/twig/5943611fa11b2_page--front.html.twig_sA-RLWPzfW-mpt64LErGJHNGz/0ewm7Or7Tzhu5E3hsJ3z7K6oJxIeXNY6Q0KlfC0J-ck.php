...
class __TwigTemplate_0165acb4b706da3f4adb58567912fcd42dcb0b05e31d4a6f11b22571c70951d4 extends Twig_Template
{
...
($context["theme"] ?? null), "settings", array()), "navbar_inverse", array())) ? ("navbar-inverse") : ("navbar-default")), 2 => (($this->getAttribute($this->getAttribute(        // line 66
...
($context["page"] ?? null), "sidebar_first", array())) ? ("col-sm-9") : ("")), 1 => ((($this->getAttribute(        // line 130
($context["page"] ?? null), "sidebar_first", array()) && twig_test_empty($this->getAttribute(($context["page"] ?? null), "sidebar_second", array())))) ? ("col-sm-9") : ("")), 2 => ((twig_test_empty($this->getAttribute(        // line 131
...
{% if page.footer %}
    ...
    {% endblock %}
{% endif %}
", "themes/custom/ecommerse/templates/system/page--front.html.twig", "C:\\wamp64\\www\\Project\\Ecommerse-Drupal\\themes\\custom\\ecommerse\\templates\\system\\page--front.html.twig");
    }
}
